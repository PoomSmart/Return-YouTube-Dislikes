...
The tweak also provides an option to submit your like/dislike data to their RYD database. Head over to Settings > General and you will see "Enable vote submission" option near the bottom. This option is disabled by default.
...
- `make` or `make package FINALPACKAGE=1`
